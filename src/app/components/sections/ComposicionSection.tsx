...
export function ComposicionSection() {
  ...
  return (
    <section id="composicion" className="section-container py-10 md:py-16">
      <div className="flex items-baseline gap-0 mb-1.5">
        <SectionNum n="§ 03" />
        <h2 className="font-editorial text-xl md:text-[26px] font-medium text-ink">
          La Nueva Composición Parlamentaria 2026&ndash;2030
        </h2>
      </div>
      <p className="text-xs md:text-[13px] text-slate mb-8 pl-0 md:pl-12">
